...
Portanto, é aqui que se encontram as referências ao \emph{Buddha},
\emph{Dhamma,} \emph{Sangha}. Porque é que eu valorizo isso, porque é
que tomo refúgio no \emph{Buddha}, \emph{Dhamma,} \emph{Sangha}? Porque isto é
...
Gachami} (eu tomo refúgio no \emph{Buddha})\emph{; Dhammam Saragnam Gachami}
...
é ver isso em termos daquilo que é \emph{sankhāra} (formação mental), a
...
mais a pessoa a possuir a condição, é-se \emph{Buddho}, o Buddha a observar e a
...
costumava sempre dizer, ``morre antes de morrer'' que em tailandês diz"-se
...
isso e, então, este pensar cria esta dúvida (\emph{vicikicchā}). É por
